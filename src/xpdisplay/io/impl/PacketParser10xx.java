...
import xpdisplay.model.data.*;
import xpdisplay.ui.XPDisplayFrame;

import java.util.ArrayList;
import java.util.List;

public class PacketParser10xx extends PacketParser {
    private XPDisplayFrame f;

    public PacketParser10xx(final XPDisplayFrame f) {
        this.f = f;
    }
...
//                    System.out.print("  "+readFloat(data[i++], data[i++], data[i++], data[i++]));
                ...
                switch( index ) {
                    ...
                    case 17 : pitchRollHeading(values, results); break;
                    case 19 : compass(values, results); break;
...
//        o.setMagneticVariation(values[7]);
    ...
    protected void compass(float[] values, List<DataObject> results) {
//        System.out.println("PRH: "+printArray(values));
        ...
        Attitude o = new Attitude();
        o.setHeadingCompass(values[0]);
        o.setMagneticVariation(values[1]);
        results.add(o);
    }
